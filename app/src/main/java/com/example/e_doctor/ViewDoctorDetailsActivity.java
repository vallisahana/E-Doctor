...
public class ViewDoctorDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = findViewById(R.id.userdetailistviewdoc);
        ...
        dbh = new DatabaseDoc(getApplicationContext());
        sqLiteDatabase = dbh.getReadableDatabase();
        res = dbh.UserData();
        la = new Doc_ListAdapter(getApplicationContext(), R.layout.doctor_row);
        ...
        if (res.moveToFirst()) {
            do {
               ...
               Dataprovider_Doc DPC = new Dataprovider_Doc(name, email, password, phone);
                la.add(DPC);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                if (res1.getCount() > 0) {
                    ...
                    Toast.makeText(ViewDoctorDetailsActivity.this, "Not found", Toast.LENGTH_LONG).show();
                    return;
        ...
        btnsearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (res2.moveToFirst()) {
                    ...
                    Toast.makeText(ViewDoctorDetailsActivity.this, "Please enter valid Name", Toast.LENGTH_LONG).show();
                    return;
                }
        ...
        btndelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (res2.getCount() > 0 && !res2.equals(res2)) {
                    Toast.makeText(ViewDoctorDetailsActivity.this, "Enter vaild Name", Toast.LENGTH_LONG).show();
                    return;
                } else {
                    Toast.makeText(ViewDoctorDetailsActivity.this, "Successfully Deleted refresh to View", Toast.LENGTH_LONG).show();
                    return;
